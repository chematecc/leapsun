  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(rgba(26,38,53,0.9) 1px, transparent 1px)',
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        {/* Cards — 6-col grid: row 1 = 3 × col-span-2, row 2 = 2 × col-span-2 centred */}
        <motion.div
          initial="hidden"
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden transition-all duration-500 hover:-translate-y-2 ${colClass}`}
                style={{
                  background: `linear-gradient(150deg, ${s.bg} 0%, #ffffff 100%)`,
              ...
              >
                ...
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-b"
                  style={{ boxShadow: `inset 0 -3px 0 0 ${s.accent}40, 0 24px 48px -12px ${s.accent}20` }}
                />
                ...
                <div className="relative p-8 lg:p-10">
                  {/* Large faded number — decorative watermark */}
                  <div
                    className="absolute -top-3 right-5 pointer-events-none select-none font-light leading-none"
                    style={{ fontSize: '6.5rem', color: `${s.accent}0E` }}
                  >
                  ...
                  {/* Icon */}
                  <div
                    className="w-12 h-12 flex items-center justify-center mb-8 transition-transform duration-300 group-hover:scale-110"
                    style={{
                      color: s.accent,
                  ...
                  <h3 className="text-[#1A2635] text-[1rem] font-semibold tracking-tight mb-3 leading-snug">
                    {item.title}
                  </h3>
                  <p className="text-[#1A2635]/50 text-sm leading-relaxed">
                    {item.desc}
                  </p>

                  {item.url && (
                    <div
                      className="mt-7 flex items-center gap-2 text-[10px] tracking-widest uppercase font-medium opacity-0 group-hover:opacity-100 translate-x-0 group-hover:translate-x-1 transition-all duration-300"
                      style={{ color: s.accent }}
                    >

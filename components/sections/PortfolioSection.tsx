  ...
  },
  {
    ...
    companies: [
      ...
      },
      {
        ...
        name: 'Hawkeyes',
        nameZh: '禾楷电气',
        tagline: 'Laser Detection & Substation Intelligence',
        taglineZh: '激光检测与变电站在线智能监控',
        desc: 'High-tech innovator specialising in self-developed laser detection technology and instruments — backed by a certified cleanroom photonics lab and multiple invention patents with international type-test approval. Provides online monitoring systems and integrated condition-based maintenance solutions for large substation equipment, enabling precise fault detection, early-warning and full operational lifecycle management.',
        descZh: '以自主创新激光检测技术为核心，建有洁净无尘光电子实验室，持有多项发明专利，产品通过国际互认检测与型式试验。面向变电站大型设备提供在线检测仪器及数据平台、项目实施、设备维护、系统集成、运维管理等全流程服务，实现设备内部运行状态精确掌控、故障提前预警，同时提供状态检修综合解决方案，助力电力基础设施安全稳定运行。',
      ...
      },
      {
        ...
        name: 'SurMeta',
        nameZh: '申美信息',
        tagline: 'Making Digital Transformation Verifiable',
        taglineZh: '让数智化建设成为可验证的业务结果',
        desc: 'Drives enterprise intelligence with AI, large models, data intelligence, software engineering, digital twins, AIoT and cloud infrastructure. Delivers industry-specific solutions across finance, automotive, telecom, energy, manufacturing and consumer sectors.',
        descZh: '以 AI、大模型、数据智能、软件工程、测试工程、数字孪生、AIoT 与云基础设施能力，服务企业从信息化走向智能化。以金融、汽车、通信、能源、制造和消费等行业为主线，将数据、AI 和工程交付能力落到具体业务结果。',

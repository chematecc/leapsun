  ...
  },
  {
    ...
    companies: [
      ...
      },
      {
        ...
        name: 'Hawkeyes',
        nameZh: '禾楷电气',
        tagline: 'Laser Detection for Power & Industrial Equipment',
        taglineZh: '激光检测仪器与工业设备在线监控',
        desc: 'Self-developed laser detection technology backed by a certified cleanroom photonics lab and multiple invention patents. Serves substations and large industrial enterprises with online monitoring instruments, fault early-warning systems, and end-to-end condition-based maintenance solutions.',
        descZh: '以自主研发激光检测技术为核心，建有洁净无尘光电子实验室，持有多项发明专利。为变电站及大型生产企业提供在线监测仪器与设备，实现故障精确检测与提前预警，并提供涵盖数据平台、系统集成与运维管理的状态检修综合解决方案。',

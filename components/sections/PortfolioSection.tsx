    ...
    companies: [
      {
        ...
        taglineZh: '神经康复机器人',
        desc: 'Blends neuroscience with rehabilitation robotics, pioneering brain-computer interfaces and neuro-rehab systems. Bridges scientific discovery and clinical outcomes for stroke and neurological recovery patients.',
        descZh: '融合神经科学与康复机器人技术，深耕脑机接口与神经康复领域，将科学发现转化为临床应用，助力中风及神经系统疾病患者的功能恢复。公司在非侵入式脑机接口与运动康复机器人研发领域持续突破，积极推动临床转化落地。',
